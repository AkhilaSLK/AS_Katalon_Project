...
WebUI.verifyTextPresent('Welcome Admin', false, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/Page_OrangeHRM/a_Welcome Admin'), FailureHandling.CONTINUE_ON_FAILURE)
