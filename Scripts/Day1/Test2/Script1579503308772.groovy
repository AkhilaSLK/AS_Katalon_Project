...
WebUI.setText(findTestObject('Web/Page_CURA Healthcare Service/textarea_Comment_comment'), 'test appointment')

WebUI.click(findTestObject('Web/Page_CURA Healthcare Service/button_Book Appointment'))

WebUI.verifyElementPresent(findTestObject('Web/Page_CURA Healthcare Service/h2_Appointment Confirmation'), 0)
